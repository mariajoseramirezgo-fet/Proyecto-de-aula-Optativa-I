...
<img src="img/productos/<?php echo $producto['imagen']; ?>" width="300">
</div>
...
<p>
<?php echo $producto['descripcion'] ?? 'Producto disponible en tienda'; ?>
</p>

<p><b>Stock:</b> <?php echo $producto['stock_actual']; ?></p>
...
<button class="btn alquilar" onclick="alquilar()">
Alquilar
</button>
...
<p><b>Producto:</b> <?php echo $producto['nombre']; ?></p>

<p><b>Precio:</b> $<?php echo number_format($producto['precio_venta']); ?></p>
...
/* TOTAL */
let precio = <?php echo $producto['precio_venta']; ?>;

function calcular(){
    let cant = document.getElementById("cantidad").value;
    document.getElementById("total").textContent = (precio * cant).toLocaleString();
}
...
function comprar(){
    ...
    "comprar.php?id=<?php echo $producto['id_producto']; ?>&cantidad=" + cantidad;
}
...
function alquilar(){
    window.location.href = "alquileruser.php?id=<?php echo $producto['id_producto']; ?>";
}
