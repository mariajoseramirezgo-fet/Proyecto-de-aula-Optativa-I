...
<div class="container">
    ...
    <main class="main-content">
        ...
        <p>
            Análisis detallado de ventas y alquileres del periodo actual.
        </p>
        ...
        <div class="cards">
            ...
            <div class="card-venta">
                ...
                <p>
                    <?php echo $productosVendidos; ?> productos
                </p>
            ...
            <div class="card-alquilados">
                ...
                <p>
                    <?php echo $alquileresActivos; ?> productos
                </p>
...
new Chart(ctx,{
    ...
    data:{
        ...
        datasets:[{
            ...
            data:
            <?php echo json_encode($datosGrafica); ?>,
